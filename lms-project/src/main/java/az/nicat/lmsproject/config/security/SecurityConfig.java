package az.nicat.lmsproject.config.security;


import az.nicat.lmsproject.security.AuthFilterConfigurerAdapter;
import az.nicat.lmsproject.security.jwt.JwtAuthenticationEntryPoint;
...
//        http.cors(cors -> cors.disable());
        ...
        http.authorizeHttpRequests(auth -> auth.requestMatchers("/swagger-ui*/**", "/v3/api-docs/**","/ws/**").permitAll());
